  ...
  \begin{itemize}
    ...
    \begin{center}
      \begin{tikzpicture}[
          ...
          \draw[-{Stealth}] (0.5, 0) -- (2.5, 0) node[anchor=north west] {$J^{0}_{0}$};
...
\begin{frame}{Affine highest-weight representations of \texorpdfstring{$\widehat{\mathfrak{sl}_{2}}$}{Lg}}
  ...
  \begin{tikzpicture}[node distance=4cm] 
      ...
      \node[draw, thick, font=\sffamily, align=center] (c1) {$\mathcal{R}^{j}$ of $\mathfrak{sl}_{2}$};

      \node[draw, thick, font=\sffamily, right=of c1, align=center] (c2) {$\widehat{\mathcal{R}}^{j}$ of $\widehat{\mathfrak{sl}_{2}}$};
